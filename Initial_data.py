...
class DataSet():
    ...
    def __init__(self, basedir):
        ...
        self.train_data = pd.read_csv(read_dir + "model_train_data_2.csv", index_col='username')
        self.test_data = pd.read_csv(read_dir + "model_test_data_2.csv", index_col='username')
